VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptSalarioGerentes 
   Bindings        =   "rptSalarioGerente.dsx":0000
   Caption         =   "Sal G"
   ClientHeight    =   4305
   ClientLeft      =   60
   ClientTop       =   345
   ...
   BottomMargin    =   500
   _Settings       =   31
   DataMember      =   "cmdSqlSalarioGerentes"
   NumSections     =   5
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "rptSalarioGerentes"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Initialize()
    rptSalarioGerentes.Orientation = rptOrientLandscape
End Sub
