VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptGRID_Caixa 
   Bindings        =   "rptGRIDcaixa.dsx":0000
   Caption         =   "Relatorio de Salarios dos Caixas"
   ClientHeight    =   11115
   ClientLeft      =   195
   ClientTop       =   585
   ClientWidth     =   11925
   Icon            =   "rptGRIDcaixa.dsx":0011
   ...
   BottomMargin    =   100
   _Settings       =   7
   DataMember      =   "cmdSqlCaixaComissao2_Grouping"
   NumSections     =   7
   SectionCode0    =   1
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
            ...
            SubFormatType   =   0
         EndProperty
         DataMember      =   "cmdSqlCaixaComissao2"
      EndProperty
      ItemType1       =   4
   ...
   EndProperty
End
Attribute VB_Name = "rptGRID_Caixa"
