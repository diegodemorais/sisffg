VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptConfComPremioPiso 
   Bindings        =   "rptConfComPremioPiso.dsx":0000
   Caption         =   "FICHA MENSAL - Vcto (F)"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   Icon            =   "rptConfComPremioPiso.dsx":0011
   ...
   BottomMargin    =   100
   _Settings       =   7
   DataMember      =   "cmdSqlConfComPremioPiso_Grouping"
   NumSections     =   7
   SectionCode0    =   1
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
            ...
            SubFormatType   =   0
         EndProperty
         DataMember      =   "cmdSqlConfComPremioPiso"
      EndProperty
      ItemType1       =   4
      BeginProperty Item1 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
   ...
   EndProperty
End
Attribute VB_Name = "rptConfComPremioPiso"
