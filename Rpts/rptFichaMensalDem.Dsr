VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptFichaMensalDem 
   Bindings        =   "rptFichaMensalDem.dsx":0000
   Caption         =   "FICHA MENSAL - (D)"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   Icon            =   "rptFichaMensalDem.dsx":0011
   ...
   BottomMargin    =   200
   _Settings       =   7
   Title           =   "Relatório de Dispensa"
   DataMember      =   "cmdSqlFichaMensalDem_Grouping"
   NumSections     =   7
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "rptFichaMensalDem"
