VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptRelVistoFixoZerados 
   Bindings        =   "rptRelVistoFixoZerados.dsx":0000
   Caption         =   "Relação de Vistos"
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "rptRelVistoFixoZerados.dsx":0011
   ...
   BottomMargin    =   200
   _Settings       =   7
   DataMember      =   "cmdSqlVistarFixos2Zerados_Grouping"
   NumSections     =   7
   SectionCode0    =   1
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
            ...
            SubFormatType   =   2
         EndProperty
         DataMember      =   "cmdSqlVistarFixos2Zerados"
      EndProperty
      ItemType1       =   5
   ...
   EndProperty
End
Attribute VB_Name = "rptRelVistoFixoZerados"
