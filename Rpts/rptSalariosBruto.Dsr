VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptSalariosBruto 
   Bindings        =   "rptSalariosBruto.dsx":0000
   Caption         =   "Relatório de Salários Brutos"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11925
   Icon            =   "rptSalariosBruto.dsx":0011
   ...
   BottomMargin    =   100
   _Settings       =   7
   DataMember      =   "cmdRelSalarios_Grouping"
   NumSections     =   7
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "rptSalariosBruto"
