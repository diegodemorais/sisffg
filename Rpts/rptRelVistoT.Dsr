VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptRelVistoT 
   Bindings        =   "rptRelVistoT.dsx":0000
   Caption         =   "Relação de Vistos"
   ClientHeight    =   7755
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11325
   Icon            =   "rptRelVistoT.dsx":0011
   ...
   BottomMargin    =   200
   _Settings       =   7
   DataMember      =   "cmdSqlVistar_Grouping"
   NumSections     =   7
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "rptRelVistoT"
