VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptGRID_Gerente 
   Bindings        =   "rptGRIDgerente.dsx":0000
   Caption         =   "Relatorio de Salarios dos Caixas"
   ClientHeight    =   11115
   ClientLeft      =   195
   ClientTop       =   585
   ClientWidth     =   11925
   Icon            =   "rptGRIDgerente.dsx":0011
   ...
   BottomMargin    =   100
   _Settings       =   7
   DataMember      =   "cmdSqlGerenteComissao"
   NumSections     =   5
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "rptGRID_Gerente"
