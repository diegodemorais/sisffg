...
On Error Resume Next
    ...
    If Not (adoReg.Recordset.EOF) Then
        ...
        If adoReg.Recordset.EOF Then
            MsgBox "Não existe esta ficha no Mês " & txt_PMes & "!", vbCritical, "Ficha não encontrada"
            adoReg.Recordset.MoveFirst
    ...
    Select Case adoReg.Recordset.Fields("F_TIPO")
            ...
            If adoReg.Recordset.Fields("F_COD_CENTRAL") <> "" Then
                        ...
                        w_ultDiaMes = 30
                         ...
                         If (w_DtDiff < w_ultDiaMes) And (w_DtDiff < 30) Then
                             ...
                             If (adoComis.Fields("COMTOTAL") + adoComis.Fields("F_1373503546")) <= w_Piso Then
                                 de.cmdIncluirDescCalc Date, adoReg.Recordset.Fields("M_NFICHA"), 23, "+", Format(w_Piso, "0.00"), "#NÃO ATINGIU O PISO# Comissao: " & Format(w_Comis, "0.00") & " + Prêmio: " & Format(w_Premio, "0.00") & " = " & Format(w_Comis + w_Premio, "0.00") & ". Piso: " & Format(w_PisoOriginal, "0.00") & " / " & CInt(w_ultDiaMes) & " = " & Format(w_PisoOriginal / w_ultDiaMes, "0.00") & " * " & w_DtDiff & " dias = " & Format(w_Piso, "0.00"), adoReg.Recordset.Fields("M_LOGO"), "0", "0", "0", adoReg.Recordset.Fields("M_F_COD")
                             Else
                                 de.cmdIncluirDescCalc Date, adoReg.Recordset.Fields("M_NFICHA"), 20, "+", Format(w_Comis, "0.00"), "#COMISSÃO MAIOR QUE PISO PROPORCIONAL# Comissao: " & Format(w_Comis, "0.00") & " + Prêmio: " & Format(w_Premio, "0.00") & " = " & Format(w_Comis + w_Premio, "0.00") & ". Piso: " & Format(w_PisoOriginal, "0.00") & " / " & CInt(w_ultDiaMes) & " = " & Format(w_PisoOriginal / w_ultDiaMes, "0.00") & " * " & w_DtDiff & " dias = " & Format(w_Piso, "0.00"), adoReg.Recordset.Fields("M_LOGO"), "0", "0", "0", adoReg.Recordset.Fields("M_F_COD")
                         ...
                         Else
                             de.cmdIncluirDescCalc Date, adoReg.Recordset.Fields("M_NFICHA"), 23, "+", Format(w_Piso, "0.00"), "#NÃO ATINGIU O PISO# Comissao: " & Format(w_Comis, "0.00") & " + Prêmio: " & Format(w_Premio, "0.00") & " = " & Format(w_Comis + w_Premio, "0.00") & ". Piso: " & Format(w_Piso, "0.00"), adoReg.Recordset.Fields("M_LOGO"), "0", "0", "0", adoReg.Recordset.Fields("M_F_COD")
                         End If
                 ...
                 Else
                     ...
                     If (w_DtDiff < w_ultDiaMes) And (w_DtDiff < 30) Then
                         ...
                         de.cmdIncluirDescCalc Date, adoReg.Recordset.Fields("M_NFICHA"), 23, "+", Format(w_Piso, "0.00"), "#NÃO ATINGIU O PISO# Comissao: " & Format(0, "0.00") & " + Prêmio: " & Format(0, "0.00") & " = " & Format(0 + 0, "0.00") & ". Piso: " & Format(w_PisoOriginal, "0.00") & " / " & CInt(w_ultDiaMes) & " = " & Format(w_PisoOriginal / w_ultDiaMes, "0.00") & " * " & w_DtDiff & " dias = " & Format(w_Piso, "0.00"), adoReg.Recordset.Fields("M_LOGO"), "0", "0", "0", adoReg.Recordset.Fields("M_F_COD")
        
                     Else
                         de.cmdIncluirDescCalc Date, adoReg.Recordset.Fields("M_NFICHA"), 23, "+", Format(w_Piso, "0.00"), "#NÃO ATINGIU O PISO# Comissao: " & Format(0, "0.00") & " + Prêmio: " & Format(0, "0.00") & " = " & Format(0 + 0, "0.00") & ". Piso: " & Format(w_Piso, "0.00"), adoReg.Recordset.Fields("M_LOGO"), "0", "0", "0", adoReg.Recordset.Fields("M_F_COD")
                     End If
        ...
        Case "G": 'GERENTE
            ...
            If vrSalario < vrMinimo Then
                vrSalario = vrMinimo
                wDesc = "**NÃO ATINGIU O MÍNIMO** (" & Format(vrVenda, "0.00") & " x " & percComis & "% = " & Format(vrComis, "0.00") & ") + " & Format(vrFixo, "0.00") & " = " & Format(vrSalario, "0.00")
            Else
        ...
        Case "C": 'CAIXA
                ...
                If Not w_ado_vendaAnt.EOF And Not w_ado_venda.EOF Then
                    ...
                    If vrSalario < vrMinimo Then
                        vrSalario = vrMinimo
                        wDesc = "**NÃO ATINGIU O MÍNIMO** " & Format(vrVendaAnt, "0.00") & " : " & Format(vrVenda, "0.00") & " = " & Format(percVenda, "0.00") & "% x " & Format(percComis, "0.00") & "% = " & Format(vrComis, "0.00") & " + " & Format(vrFixo, "0.00") & " = " & Format(vrSalario, "0.00")
                    Else
