...
Begin VB.Form frm_Alt_Fic_Mensal_VIS 
   ...
   Begin Skin_Button.ctr_Button cmdLancamentosExpand 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_Alt_Fic_Mensal_VIS.frx":1059
      PICN            =   "frm_Alt_Fic_Mensal_VIS.frx":1075
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Skin_Button.ctr_Button cmdAddSalario 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_Alt_Fic_Mensal_VIS.frx":3F10
      PICN            =   "frm_Alt_Fic_Mensal_VIS.frx":3F2C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Skin_Button.ctr_Button cmdDescCalcFixo 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_Alt_Fic_Mensal_VIS.frx":5B4E
      PICN            =   "frm_Alt_Fic_Mensal_VIS.frx":5B6A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Sub Lancamentos()
    ...
    If ADO_LANC.Recordset.RecordCount > 0 Then
...
Private Sub cmdAddSalario_Click()
    ...
    Case "V": 'VENDEDOR
        ...
        Dim vrMeta, vrMetaBonus, descMeta, vrSalario, wFixoMeta, numLoja
    ...
    '***  entre os caixa **** calc a média ***
        ...
        If Not w_ado_vendaAnt.EOF And Not w_ado_venda.EOF Then
            ...
            If ADOREG.Recordset.Fields("M_MES") <= 12 Then
                ...
                'If W_ADO_FICHA.Fields("M_LOGO") = "LS" Then
                '    MsgBox "59!!!", vbCritical
...
Dim vrMeta, vrMetaBonus, descMeta, vrSalario, wFixoMeta, numLoja
Dim w_ado_venda As ADODB.Recordset
Dim w_ado_vendaAnt As ADODB.Recordset
    ...
    If MsgBox("Gerar Millennium? (padrão: sim)", vbYesNo, "Gerar Millennium") = vbYes Then
        de.cmdDELETEtmpComis1
        de.cmdDELETEtmpComis2
           ...
           If ADOREG.Recordset.Fields("M_TIPO") = "V" Then
            ...
            If ADOREG.Recordset.Fields("F_COD_CENTRAL") <> "" And IsNull(ADOREG.Recordset.Fields("M_DT_DEM")) Then
                ...
                If Not adoComis.EOF Then
                    ...
                    w_Premio = de.cncMwts.Execute("SELECT sum(u.premio) FROM usr_premiacao u INNER JOIN funcionarios f ON u.funcionario = f.funcionario WHERE u.filial = " & adoComis.Fields("filial_filial_filial") & " AND f.gerador = " & adoComis.Fields("funcionario_GERADOR_GERADOR")).Fields(0)
                    If IsNull(w_Premio) Then
                        w_Premio = 0
                    End If
                    'w_Premio = CDbl(adoComis.Fields("F_1373503546"))
    ...
    'Premio temporario
    premioTMP = de.cncMwts.Execute("SELECT sum(u.premio) FROM usr_premiacao u INNER JOIN funcionarios f ON u.funcionario = f.funcionario WHERE u.filial = " & adoComisDump.Fields("filial_filial_filial") & " AND f.gerador = " & adoComisDump.Fields("funcionario_GERADOR_GERADOR")).Fields(0)

     
    'IIf(IsNull(adoComisDump.Fields("F_1373503546")), 0, adoComisDump.Fields("F_1373503546")),
    ...
    de.cmdSqlAddComissTMP IIf(IsNull(adoComisDump.Fields("cod_filial")), "", adoComisDump.Fields("cod_filial")), _
        ...
        IIf(IsNull(premioTMP), 0, premioTMP), _
        ...
        (IIf(IsNull(premioTMP), 0, premioTMP) + IIf(IsNull(adoComisDump.Fields("comTotal")), 0, adoComisDump.Fields("comTotal")))
...
Dim dtIni, dtFim As Date
Dim vrMeta, vrMetaBonus, descMeta, vrPisoMeta, numLoja
            ...
            'If vrVenda <> "" Then
             ...
             vrMetaParc = 0
              If ADOREG.Recordset.Fields("m_mes") <= 12 Then
                ...
                'vrMetaParc = Math.Round(vrMeta * 0.9, 0)
                'vrMetaParc = Math.Round(vrMeta * 1.1, 0)
                'If (vrVenda >= vrMetaParc) Then
                'If (vrVenda >= vrMeta) Then
                '    wFixoMeta = 0
                '    If (vrVenda >= vrMetaParc) Then
                ...
                If vrSalario < vrMinimo Then
                    vrSalarioBonus = vrMinimo + vrMetaBonus + vrBonusAnt
                Else
                    vrSalarioBonus = vrSalarioBonus + vrMetaBonus + vrBonusAnt
                End If
...
If clickMenu = False Then Exit Sub
...
Private Sub Excluir(Optional ByVal skipConfirmation As Boolean = False)
On Error GoTo err1
