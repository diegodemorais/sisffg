           ...
           If ADOREG.Recordset.Fields("M_TIPO") = "V" Then
            ...
            If ADOREG.Recordset.Fields("F_COD_CENTRAL") <> "" And IsNull(ADOREG.Recordset.Fields("M_DT_DEM")) Then
                ...
                If Not adoComis.EOF Then
                    ...
                    w_Premio = de.cnc.Execute("SELECT sum(u.premio) FROM usr_premiacao u INNER JOIN funcionarios f ON u.funcionario = f.funcionario WHERE u.filial = " & adoComis.Fields("filial_filial_filial") & " AND f.gerador = " & adoComis.Fields("funcionario_GERADOR_GERADOR")).Fields(0)
                    'w_Premio = CDbl(adoComis.Fields("F_1373503546"))
