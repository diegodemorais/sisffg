            ...
            'If vrVenda <> "" Then
             ...
             wPercBonusAnt = 0
              ...
              End If
                ...
                If vrSalario < vrMinimo Then
                    wDesc = "**NÃO ATINGIU O MÍNIMO** (" & Format(vrVenda, "0.00") & " x " & percComis & "% = " & Format(vrComis, "0.00") & ") = " & Format(vrSalario, "0.00") & " < Mínimo(" & Format(vrMinimo, "0.00") & ") " & descMeta & " = " & Format(vrSalarioBonus, "0.00")
                Else
                    wDesc = "(" & Format(vrVenda, "0.00") & " x " & percComis & "% = " & Format(vrComis, "0.00") & ") = " & Format(vrSalario, "0.00") & descMeta & " = " & Format(vrSalarioBonus, "0.00")
                End If
