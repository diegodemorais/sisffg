...
Begin VB.Form FRM_LIBERAR 
   BackColor       =   &H00C0E0FF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   " LIBERAÇÃO / BLOQUEIO DE FICHAS"
   ClientHeight    =   5175
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   6240
   Icon            =   "FRM_LIBERAR.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   Begin VB.ListBox txt_tipo 
      Enabled         =   0   'False
      Height          =   2010
      ItemData        =   "FRM_LIBERAR.frx":12D2
      Left            =   1440
      List            =   "FRM_LIBERAR.frx":12F1
   ...
   Begin VB.ComboBox cbAcao 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "FRM_LIBERAR.frx":1348
      Left            =   3960
      List            =   "FRM_LIBERAR.frx":1352
      TabIndex        =   17
      Top             =   480
      Width           =   1860
   End
   ...
   Begin VB.ComboBox TXT_MES 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "FRM_LIBERAR.frx":1AD8
      Left            =   3960
      List            =   "FRM_LIBERAR.frx":1B00
      TabIndex        =   2
      Top             =   1200
      Width           =   780
   End
